...
## Project Structure
    ...
    ├── testapiautosetting_127320  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127320`
...
2. Clone this repo and `cd testapiautosetting_127320`
